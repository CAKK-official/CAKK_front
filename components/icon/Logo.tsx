...
const Logo: React.FC<IconInterface> = ({ width, height, color }) => {
  return (
    <svg
      width={width}
      height={height}
      viewBox="0 0 189.000000 58.000000"
      // fill="none"
    ...
    >
      ...
      >
        <path
          d="M187 526 c-58 -16 -110 -64 -126 -115 -18 -61 -14 -169 9 -219 27
...
-39 96 -41 19 -146 23 -198 8z"
        ...
        <path
          fill={color ? color : '#EE8288'}
          d="M600 531 c-77 -17 -107 -48 -121 -127 -5 -32 -16 -94 -24 -136 -23
...
-46 -45 -46 -38 0 -52 4 -57 16 -8 21 22 44 57 44 14 0 35 -6 45 -14z"
        ...
        <path
          fill={color ? color : '#EE8288'}
          d="M983 525 c-37 -16 -40 -25 -47 -145 -3 -47 -8 -108 -12 -137 -9 -69
...
-3z"
        ...
        <path
          fill={color ? color : '#EE8288'}
          d="M1449 529 c-36 -13 -46 -45 -54 -159 -3 -52 -8 -114 -11 -138 -12
